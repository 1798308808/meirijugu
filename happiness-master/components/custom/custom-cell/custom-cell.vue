<template>
	<view class="cts-basic-horizontal-padding" :class="[short?'cts-cell-short':'cts-cell-full']" @tap="tapped">
		...
		<view v-else-if="type==5" class="cts-cell-normal cts-flex-dir cts-flex-jsb cts-flex-ac">
			<text class="cts-cell-normal-text">{{title}}</text>
			<input class="cts-cell-input-right" :disabled="mute" :type="input_type?input_type:'text'" :value="val" :placeholder="sub_title" @input="typing"/>
		</view>
		...
		<view v-else-if="type==7" class="cts-cell-normal cts-flex-dir cts-flex-jfs cts-flex-ac">
			...
			<input class="cts-cell-input-left" :disabled="mute" :type="input_type?input_type:'text'" :value="val" :placeholder="sub_title" @input="typing"/>		
		</view>
		...
		<view v-else-if="type==11" class="cts-cell-normal cts-flex-dir cts-flex-jsb cts-flex-ac">
			<view class="cts-flex-dir cts-flex-jfs cts-flex-ac">
				...
				<view class="cts-empty-row"></view>
				<input class="cts-cell-input-left-short" :disabled="mute" :type="input_type?input_type:'text'" :value="val" :placeholder="sub_title" @input="typing"/>
			</view>
			<text class="cts-cell-button" @tap="tapped">{{btn_text||'绑定'}}</text>
		</view>
		<view v-else-if="type==12" class="cts-cell-normal cts-flex-dir cts-flex-jsb cts-flex-ac">
			<view class="cts-flex-dir cts-flex-jfs cts-flex-ac">
				...
				<view class="cts-empty-row"></view>
				<input class="cts-cell-input-left-ext-short" :disabled="mute" :type="input_type?input_type:'text'" :value="val" :placeholder="sub_title" @input="typing"/>
			</view>
		...
		<view class="cts-cell-cover" v-if="mute&&(type!=7||type!=11||type!=12)"></view>
