<template>
	<view class="cts-category cts-border-bottom-solid-btm" elevation="2px" >
	...
	export default {
		...
		methods:{
			...
			select(index){
				...
				this.$emit('returnFileterUpdate',{page:this.id,index})
			}
		}
	}
</script>
...
<style lang="scss" scoped>
	@include createBorder(btm,bottom,$cts-soso-grey,solid,1px)
	.cts-category{
		&-header{
